...
public class App_preference implements Sp_model {
    ...
    final String PREF_NAME = "eot_pref";
    ...
    private final String TEMP_BOOL = "TEMP_BOOL";
    private final String CALENDER_SELECTED_DATE = "TEMP_BOOL";
    private final String Brand="brandlist";
...
//    private final String APP_KILL_TIME = "app_kill_time";
    ...
    public List<BrandData> getBrandList() {
        String convert=sp.getString(Brand,"");
    ...
    @Override
    public void setBrandLists(String brand) {
    ...
    @Override
    public List<GetCatgData> getcatglist() {
        String convert=sp.getString(CategryList,"");
        Type listType=new TypeToken<List<GetCatgData>>(){
        }.getType();
        List<GetCatgData> catglist=new Gson().fromJson(convert,listType);
        return  catglist;
    }

    @Override
    public void setcatglist(String catglist) {
         editor.putString(CategryList,catglist);
         editor.commit();
    }
    ...
    @Override
    public String getCalenderSelectedDate() {
        return sp.getString(CALENDER_SELECTED_DATE, "");
    }

    @Override
    public void setCalenderSelectedDate(String dateTime) {
        editor.putString(CALENDER_SELECTED_DATE, dateTime);
        editor.commit();
    }
...
//    }
    ...
    @Override
    public List<EquipmentStatus> geteqstatuslist() {
        String convert=sp.getString(EqstatusList,"");
        Type listType=new TypeToken<List<EquipmentStatus>>(){
        }.getType();
        List<EquipmentStatus> eqsatatuslist=new Gson().fromJson(convert,listType);
        return  eqsatatuslist;
    }

    @Override
    public void seteqstatuslist(String  equipmentStatuses) {
           editor.putString(EqstatusList,equipmentStatuses);
           editor.commit();
    }
    ...
    @Override
    public void setIsCheckInOutDesc(String dateTime) {
    ...
    @Override
    public void setIsCheckInOutAttachment(String dateTime) {

    }

    @Override
    public List<GetgrpData> getgrplist() {
        String convert=sp.getString(gropList,"");
        Type listType=new TypeToken<List<GetgrpData>>(){
        }.getType();
        List<GetgrpData> grplist=new Gson().fromJson(convert,listType);
        return  grplist;
    }

    @Override
    public void setGrpList(String grpLists) {
           editor.putString(gropList,grpLists);
           editor.commit();
    }
    ...
    public Login_Responce_Model getEmailRespone() {
        Gson gson = new Gson();
        return gson.fromJson(sp.getString(EMAIL_RESPONCE, null), Login_Responce_Model.class);
    }
    ...
    public ResLoginData getLoginRes() {
        Gson gson = new Gson();
        return gson.fromJson(sp.getString(LOGIN_RESPONSE, null), ResLoginData.class);
    }
    ...
    @Override
    public String getJobStartSyncTime() {
        return sp.getString(JOBSTARTLIST_TIME, "");
    }

    @Override
    public void setJobStartSyncTime(String dateTime) {
        editor.putString(JOBSTARTLIST_TIME, dateTime);
        editor.commit();
    }
    ...
    @Override
    public ArrayList<EquipmentStatus> getEquipmentStatusList() {
        String convert = sp.getString(EQUIPMENTSTATUS, "");
        Type listType = new TypeToken<List<EquipmentStatus>>() {
        }.getType();
        return new Gson().fromJson(convert, listType);
    }
    ...
    @Override
    public void setEquipmentStatusList(String data) {
        editor.putString(EQUIPMENTSTATUS, data);
        editor.commit();
    }
    ...
    @Override
    public boolean getContactSiteSynced() {
        return sp.getBoolean(CONTACT_SITE_SYNCED, false);
    }

    @Override
    public void setContactSiteSynced(boolean isSync) {
        editor.putBoolean(CONTACT_SITE_SYNCED, isSync);
        editor.commit();
    }
    @Override
    ...
    public CompanyDetailsModel getCompanySettingsDetails() {
        try {
            Gson gson = new Gson();
            return gson.fromJson(sp.getString(COMPNY_SETTINGS, null), CompanyDetailsModel.class);
