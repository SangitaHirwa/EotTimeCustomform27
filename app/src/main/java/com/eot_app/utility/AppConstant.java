...
public class AppConstant {
    ...
    public static final String status_job_break = "JobBreak";
    ...
    public static final String go_to_addjob = "go_to_addjob";
...
//TODO
    ...
    public static String warranty_start_date = "Warranty Start Date";
    ...
    public static String are_you_sure_invoice = "are_you_sure_invoice";
    ...
    public static String please_retry = "please_retry";
    public static String back_to_login = "back_to_login";
    public static String retry = "retry";
    public static String auto_gen_bar_code =     "auto_gen_bar_code";
    public static String scan_insert_barcode = "scan_insert_barcode";
    public static String insert_barcode = "insert_barcode";
    public static String scan = "scan";
    public static String feature_not_available  = "feature_not_available";
    public static String po_number = "po_number";
    public static String misc = "misc";
    public static String static_label_will_remain_same = "static_label_will_remain_same";
    public static String note = "note";
    public static String lead = "lead";
    public static String checkout_time_less_checkin_time = "checkout_time_less_checkin_time";
    public static String checkout_time_greater_current_time = "checkout_time_greater_current_time";
    public static String the_last_checkin="the_last_checkin";
    public static String do_you_want_to="do_you_want_to";


    public static String equipment_parts= "equipment_parts";
    public static String parent_equipment= "parent_equipment";
    public static String view_edit_remark= "view_edit_remark";
    public static String days="days";
    public static String month="month";

    public static String job_card ="job_card";
    public static String select_template="select_template";
    public static String tech_sign="tech_sign";
    public static String custom_form = "custom_form";
    public static String select_equipment="select_equipment";
    public static String equipment_items= "equipment_items";
    public static String job_equipment_item= "job_equipment_item";
    public static String job_equipment_parts= "job_equipment_parts";

    public static String item_part= "item_part";
    public static String deployed="deployed";
    public static String replace="replace";
    public static String do_you_want_to_discard="do_you_want_to_discard";
    public static String replace_equipment="replace_equipment";
    public static String items="items";
    public static String step_1="step_1";
    public static String step_2="step_2";
    public static String status_sent="status_sent";
    public static String status_revised="status_revised";
    public static String service_interval="service_interval";
    public static String service_due_date="service_due_date";
    public static String title_replace_equipment="title_replace_equipment";
    public static String actual_job_time="actual_job_time";
    public static String travel_job_time="travel_job_time";
    public static String actual_start_date_time="actual_start_date_time";
    public static String actual_end_date_time="actual_end_date_time";
    public static String travel_start_date_time="travel_start_date_time";
    public static String travel_end_date_time="travel_end_date_time";
    public static String completion_details="completion_details";
    public static String title_add_equipment_part="title_add_equipment_part";
    public static String status_notes="status_notes";
    public static String do_you_want_t="do_you_want_t";

    public static String error_actual_start_end="error_actual_start_end";
    public static String error_travel_start_end="error_travel_start_end";
    public static String please_select_end_date="please_select_end_date";
    public static String please_select_start_date="please_select_start_date";
    public static String please_select_travel_end_date="please_select_travel_end_date";
    public static String please_select_travel_start_date="please_select_travel_start_date";
    public static String please_select_start_end_date="please_select_start_end_date";
    public static String please_select_start_end_travel_date="please_select_start_end_travel_date";

    public static String select_start_actual_date="select_start_actual_date";
    public static String select_end_actual_date="select_end_actual_date";
    public static String select_start_travel_date="select_start_travel_date";
    public static String select_end_travel_date="select_end_travel_date";
    public static String modifdy="modifdy";
    public static String modifdy_reavel="modifdy_reavel";
    public static String parts_s="parts_s";

    public static String select_start_date="select_start_date";
    public static String select_end_date_new ="select_end_date_new";
    public static String discarded_eq="discarded_eq";
    public static String time_out_of_scope="time_out_of_scope";


    public static String clients_eq="clients_eq";
    public static String my_equipment="my_equipment";
    public static String service_interval_type="service_interval_type";
    public static String step_2_note="step_2_note";
    public static String step_1_note="step_1_note";
    public static String do_you_want_to_save_remark="do_you_want_to_save_remark";

    public static String amount_error = "amount_error";
    public static String step_1_note_new="step_1_note_new";
    public static String link_unlink_equi="link_unlink_equi";
    public static String job_break = "job_break";
    public static String project_site_name = "project_site_name";
    public static String pleas_selec_clien_firs="pleas_selec_clien_firs";
    public static String equ_status="equ_status";


    public static String extra_feild_1="extra_feild_1";
    public static String extra_feild_2="extra_feild_2";
    public static String extra_feild_3="extra_feild_3";
    public static String extra_feild_4="extra_feild_4";
    public static String enble="enble";
    public static String disble="disble";
    public static String not_available="not_available";
    public static String schedule_text="schedule_text";
    public static String are_you_sure_reject="are_you_sure_reject";
    public static String error_retry="error_retry";
    public static String continue_="continue_";
    public static String no_internet_area="no_internet_area";

    public static String status_sent_text="Sent";
    public static String status_revised_text="Status Revised";
    public static String fetch_des="fetch_des";
    public static String timestemp="time_stemp";
    public static String dispatch="dispatch";
    public static String cannot_raise_revisit_request_for_job_which_is_already_marked_as_recurring="Cannot raise a revisit request for a job which is already marked as recurring";
    public static String select_leave_type="select_leave_type";
    ...
    public static String no_Remark_Add="no_Remark_Add";
    public static String save_to_draft="save_to_draft";
    public static String remarked="remarked";
    public static String unremarked="unremarked";
...
// ko->korean pt->Portuguese ru->russia, ja->japanees ,hi->hindi , tr->Turkish
