...
public class NotificationUtils extends ContextWrapper {
    ...
    final String ANDROID_CHANNEL_NAME = "eot";
...
//            androidChannel.setLockscreenVisibility(Notification.VISIBILITY_PRIVATE);
    ...
    public Notification.Builder getAndroidChannelNotification(int badge, String title, String message, PendingIntent resultPendingIntent) {
        if (Build.VERSION.SDK_INT >= 26) {
...
//                    .setColor(getResources().getColor(R.color.body_font_color))
    ...
    public Notification getNotificationManager(String title, String msgbody, PendingIntent pendingIntent) {
        ...
        Future obj
            ...
            public Object call() {
                try {
                    ...
                    try {
                        response = (HttpResponse) httpclient.execute(finalHttpRequest);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
    ...
    synchronized public void getBitmapfromImageUrl() {
