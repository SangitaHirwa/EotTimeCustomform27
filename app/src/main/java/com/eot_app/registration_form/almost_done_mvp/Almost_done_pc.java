...
public class Almost_done_pc implements Almost_done_pi {
    ...
    static public List<Timezones> clientTimezonesList() {
        ...
        try {
            ...
            Log.e("Error", Objects.requireNonNull(je.getMessage()));
            je.printStackTrace();
        }
        return timezones;
    }
    ...
    public String currencyId(String currency) {
        return SpinnerCountrySite.getCourrencyId(currency);
    }

    @Override
    public String timeZoneId(String timezone) {
        return SpinnerCountrySite.getTimezoneId(timezone);
    }

    @Override
    public String currencyFormatId(String currency_format) {
        return SpinnerCountrySite.getCourrencyFormatId(currency_format);
    }

    @Override
    public String LangaugeId(String laguage) {
        return SpinnerCountrySite.getLanguageId(laguage);
    }
    ...
    public String currencyName(String currency) {
        return SpinnerCountrySite.getCourrencyName(currency);
    }

    @Override
    public String timeZoneName(String timezone) {
        return SpinnerCountrySite.getTimezoneName(timezone);
    }

    @Override
    public String currencyFormatName(String currency_format) {
        return SpinnerCountrySite.getCourrencyFormatName(currency_format);
    }

    @Override
    public String LangaugeName(String laguage) {
        return SpinnerCountrySite.getLanguageName(laguage);
    }
