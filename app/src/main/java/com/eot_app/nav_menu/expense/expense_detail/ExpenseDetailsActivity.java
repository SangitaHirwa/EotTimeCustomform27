...
public class ExpenseDetailsActivity extends AppCompatActivity implements ExpenseDetails_View {
    ...
    RecyclerView expense_histry_list;
    ...
    private void initializeViews() {
        ...
        expenseStatusHistoryAdpter = new ExpenseStatusHistoryAdpter(new ArrayList<>());
    ...
    public void setExpenseDetails(ExpenseRes expenseDetails) {
        ...
        if (expenseDetails.getDateTime() != null && !expenseDetails.getDateTime().equals("")) {
            expense_date_txt.setText(AppUtility.getDateByLang(AppUtility.getDateWithFormate(Long.parseLong(expenseDetails.getDateTime()), AppConstant.DATE_FORMAT),false));
        } else {
