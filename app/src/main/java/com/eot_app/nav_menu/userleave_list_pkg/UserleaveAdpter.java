...
public class UserleaveAdpter extends RecyclerView.Adapter<UserleaveAdpter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (model.getLeaveType()!=null&&!model.getLeaveType().equals(""))
        {
            holder.leave_user.setVisibility(View.VISIBLE);
            holder.leave_user.setText(model.getLeaveType());
        }else{
            holder.leave_user.setVisibility(View.GONE);
        }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView leave_label, leave_notes,leave_user;
        ...
        public ViewHolder(View view) {
            ...
            leave_user=itemView.findViewById(R.id.leave_user);
