 ...
 */
public class TaxComponentsConverter {
    @TypeConverter
    public static List<TaxComponents> toTaxData(String strdata) {
        Type listType = new TypeToken<List<TaxComponents>>() {
        }.getType();
        List<TaxComponents> data = new Gson().fromJson(strdata, listType);
        return strdata == null ? null : data;
    }

    @TypeConverter
    public static String toStringData(List<TaxComponents> data) {
