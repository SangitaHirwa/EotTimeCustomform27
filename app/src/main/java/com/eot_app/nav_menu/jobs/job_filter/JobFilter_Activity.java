...
public class JobFilter_Activity extends AppCompatActivity implements View.OnClickListener, Job_Filter_View {
    ...
    public void setJobPriopity(ArrayList<JobPrioty> jobPrioties) {
        ...
        FilterListAdapter prityFilterAdapter = new FilterListAdapter(this, jobPrioties, (data, beanList) -> {
    ...
    @Override
    public void setstatus(final List<JobStatusModelNew> statusList) {
        AppUtility.spinnerPopUpWindow(fil_status_spinner);
        @SuppressLint("SetTextI18n") FilterListAdapter statusFilterAdapter = new FilterListAdapter(this, statusList, (data, beanList) -> {
            if (data.size() >= 4)
    ...
    public void setTagsList(final List<TagData> tagList) {
        ...
        FilterListAdapter tagFilterAdapter = new FilterListAdapter(this, tagList, (data, beanList) -> {
            if (data.size() >= 4)
