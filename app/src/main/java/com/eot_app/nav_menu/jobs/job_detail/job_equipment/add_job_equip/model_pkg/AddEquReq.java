...
public class AddEquReq {
    ...
    private String isEquReplaced="";
    private String rplacedEquId="";
    ...
    public String getIsCnvtItemParts() {
        return isCnvtItemParts;
    }

    public void setIsCnvtItemParts(String isCnvtItemParts) {
        this.isCnvtItemParts = isCnvtItemParts;
    }

    public String getIsEquReplaced() {
        return isEquReplaced;
    }

    public void setIsEquReplaced(String isEquReplaced) {
        this.isEquReplaced = isEquReplaced;
    }

    public String getRplacedEquId() {
        return rplacedEquId;
    }

    public void setRplacedEquId(String rplacedEquId) {
        this.rplacedEquId = rplacedEquId;
    }
    ...
    public AddEquReq(String type, String egId, String ecId, String zip, String city, String adr,
            ...
            , String itemId, String rate, String siteId, String isPart,
                     String status, String invId,String extraField1,
                     String extraField2,String servIntvalType,String servIntvalValue,
                     String isEquReplaced,String rplacedEquId,String isCnvtItemParts,String installedDate,String supplierId) {
        this.type = type;
        this.egId = egId;
        this.ecId = ecId;
        this.zip = zip;
