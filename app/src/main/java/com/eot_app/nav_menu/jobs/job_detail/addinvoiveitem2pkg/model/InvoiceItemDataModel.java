...
public class InvoiceItemDataModel implements Parcelable {
    ...
    public String getIsPartTempId() {
        return partTempId;
    }

    public void setIsPartTempId(String partTempId) {
        this.partTempId = partTempId;
    }

    public int getIsPartParent() {
        return isPartParent;
    }

    public void setIsPartParent(int isPartParent) {
        this.isPartParent = isPartParent;
    }

    public int getIsPartChild() {
        return isPartChild;
    }

    public void setIsPartChild(int isPartChild) {
    ...
    public InvoiceItemDataModel(String tempNm, String inm, String ijmmId, String itemId, String dataType,
            ...
            , String isBillableChange,String equId, String partTempId,int isPartParent,int isPartChild, String groupId){
//            , String partTempId,int isPartParent,int isPartChild) {//, String isBillable
        this.tempNm = tempNm;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getTempNm(), that.getTempNm()) &&
                ...
                Objects.equals(getWarrantyType(), that.getWarrantyType()) &&
                Objects.equals(getWarrantyValue(), that.getWarrantyValue())&&
                Objects.equals(getEquId(), that.getEquId())&&
