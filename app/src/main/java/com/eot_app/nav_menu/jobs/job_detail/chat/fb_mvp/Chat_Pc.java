...
public class Chat_Pc implements Chat_Pi {
    ...
    // this method for only chatFragment progress bar
    public void progressbarenable()
    {
        progressDialog = new ProgressDialog(((ChatFragment) chat_view).getActivity(), (R.style.progressbarstyle));
