...
public class JobAudit_Pc implements JobAudit_PI {
    ...
    public void uploadAttchmentOnserverForJobAudit(JobAuditSingleAttchReqModel model) {
        if (AppUtility.isInternetConnected()) {
            ...
            RequestBody audId = RequestBody.create( model.getAudId(),MultipartBody.FORM);

            RequestBody equId = RequestBody.create( model.getEquId(),MultipartBody.FORM);
            RequestBody isJob = RequestBody.create( model.getIsJob(),MultipartBody.FORM);
            RequestBody usrId = RequestBody.create( App_preference.getSharedprefInstance().getLoginRes().getUsrId(),MultipartBody.FORM);
