...
//        refresh list after local changes.
    ...
    private void addtempContactIntoDB(ClientContactAddEdit_Model model) {
        ...
        tempContact.setExtraField1(model.getExtraField1());
        tempContact.setExtraField2(model.getExtraField2());
        tempContact.setExtraField3(model.getExtraField3());
        tempContact.setExtraField4(model.getExtraField4());
        tempContact.setNotes(String.valueOf(model.getNotes()));
...
//      update contact in DB
        ...
        contactData.setIsactive(clientContactEdit.getIsactive());
        contactData.setExtraField1(clientContactEdit.getExtraField1());
        contactData.setExtraField2(clientContactEdit.getExtraField2());
        contactData.setExtraField3(clientContactEdit.getExtraField3());
        contactData.setExtraField4(clientContactEdit.getExtraField4());
        contactData.setDef(String.valueOf(clientContactEdit.getDef()));
        contactData.setNotes(String.valueOf(clientContactEdit.getNotes()));
