...
//        set observer for callback
    ...
    public void onPageSelected(int position) {
        ...
        switch (position) {
            case 0:
                navigation.getMenu().getItem(position).setTitle(LanguageController.getInstance().getMobileMsgByKey(AppConstant.client_details));
                try {
    ...
    class MypagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return LanguageController.getInstance().getMobileMsgByKey(AppConstant.client_details);
                case 1:
