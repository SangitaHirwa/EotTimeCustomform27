...
public class AdpterJobHistory extends RecyclerView.Adapter<AdpterJobHistory.MyViewHolder> {
    ...
    final int unScheduleHeaderPos = -1;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        String today_date = AppUtility.getDateByFormat(AppUtility.dateTimeByAmPmFormate("EEE, "+AppConstant.DATE_FORMAT+" ,hh:mm ,a"
                , "EEE, "+AppConstant.DATE_FORMAT+" ,HH:mm"));
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onJobSelection != null)
                        try {
                            onJobSelection.onJobSelected(jobdata.get(getBindingAdapterPosition()));
