...
public class Client_Overview extends Fragment implements Client_Overview_view, View.OnClickListener {
    ...
    StringBuffer sb;
    //Button getlatlong;
    TextView client_txt, adderes_client, clint_details, account_dtls, ac_type, gst_no, tin_no, industry, lbl_notes, txt_refrence, txt_refrence_lable;
    // TODO: Rename and change types of parameters
    private Client client;
    private OverView_pi presenter;
    private CardView lat_lng_card;
    TextView lat_lng_txt;
        ...
        switch (view.getId()) {
            ...
            case R.id.email:
                if (email.getText().toString().trim().length() > 0) {
                    AppUtility.sendRequestToJoin(email.getText().toString().trim(), "", "", Objects.requireNonNull(getActivity()));
                }
                break;
