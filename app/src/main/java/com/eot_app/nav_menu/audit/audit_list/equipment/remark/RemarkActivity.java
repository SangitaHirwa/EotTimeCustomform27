 ...
 */
public class RemarkActivity extends UploadDocumentActivity implements JobAudit_View,
    ...
    private static final int PHOTO_EDIT_CODE = 1471;
     ...
     final int ATTACHFILE_CODE = 1021;
    ...
    AppCompatTextView tv_label_condition, tv_label_remark, tv_label_attachment, click_here_txt, upload_lable, tv_label_customForm_que;
    private EditText edit_remarks;
    private Spinner status_spinner;
    private TextView status_label;
    LinearLayout audit_status_relative, formLayout;
...
//                return;
    ...
    private void selectAttachment() {
        ...
        if (!Utils.isOnline(this)) {
            ...
            AppUtility.alertDialog(this, LanguageController.getInstance().getMobileMsgByKey(AppConstant.dialog_error_title),  LanguageController.getInstance().getMobileMsgByKey(AppConstant.feature_not_available), LanguageController.getInstance().getMobileMsgByKey(AppConstant.ok), "", new Callable<Boolean>() {
                @Override
                public Boolean call() throws Exception {
                    return null;
                }
