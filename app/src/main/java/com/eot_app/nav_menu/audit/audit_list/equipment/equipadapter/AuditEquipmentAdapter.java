...
public class AuditEquipmentAdapter extends RecyclerView.Adapter<AuditEquipmentAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            add_remark = itemView.findViewById(R.id.action_btn);
        ...
        void setRemarkActivity() {
            if (onEquipmentSelection != null) {
                onEquipmentSelection.onEquipmentSelected(getBindingAdapterPosition(),
                        list.get(getBindingAdapterPosition()));
            } else {
                String strEqu = new Gson().toJson(list.get(getBindingAdapterPosition()));
