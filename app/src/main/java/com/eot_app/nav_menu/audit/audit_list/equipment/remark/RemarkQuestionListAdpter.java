...
public class RemarkQuestionListAdpter extends RecyclerView.Adapter<RemarkQuestionListAdpter.ViewHolder> {
    ...
    public RemarkQuestionListAdpter(ArrayList<QuesRspncModel> typeList,
                                    Context context, MyFormInterFace myFormInterFace,
    ...
    public RemarkQuestionListAdpter(ArrayList<QuesRspncModel> typeList,
                                    Context context, MyFormInterFace myFormInterFace,
                                    MyAttachment myAttachment,boolean isBackgroundWhite) {
        this.context = context;
        this.typeList = typeList;
    ...
    public void onBindViewHolder(final RemarkQuestionListAdpter.ViewHolder holder, final int position) {
        ...
        if(isBackgroundWhite){
            ...
            holder.mainCard.setCardBackgroundColor(ContextCompat.getColor(context,R.color.window_background));
        }
                                ...
                                try {
                                    ...
                                    SimpleDateFormat format2 = new SimpleDateFormat(
                                            AppUtility.dateTimeByAmPmFormate(
                                                    "dd-MMM-yyyy hh:mm a"
                                                    , "dd-MMM-yyyy HH:mm"),Locale.ENGLISH);
                                    Date date1=format1.parse(newdateTime);
                                     sTimeDate = format2.format(date1);
                                    textView.setText(AppUtility.getDateByLang(sTimeDate,true));
                                } catch (ParseException e) {
                                    textView.setText(AppUtility.getDateByLang(newdateTime,true));
                                    e.printStackTrace();
                                }
                ...
                public void onDateSet(DatePicker view, int year, int monthOfYear,
                    ...
                    /**type 7 for DateTime type Question***/
                        ...
                        SimpleDateFormat sdf = new SimpleDateFormat(AppUtility.dateTimeByAmPmFormate(
                                "dd-MM-yyyy hh:mm a", "dd-MM-yyyy HH:mm"), Locale.ENGLISH);
                        try {
