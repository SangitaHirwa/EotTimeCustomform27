...
//    private final String[] arraystatus = {"In Progress", "On Hold", "Completed"};//"Job Break",
    ...
    ImageView imageViewChat, imageViewCall, imageViewEmail, imageView5;
    private View layout;
    Button button_resume, button_start, button_on_hold, button_completed, buttonView, buttonMapView, buttonView1;
    private Spinner status_spinner;
    TextView status_label, textViewJobCode, textViewTime, textViewPriority, textViewJobStatus, textViewAddress, textViewDescription, textViewContactperson, textViewTitle, textViewInstruction, txtViewHeader, txt_fw_nm_list, tv_location, tv_description, tv_instruction, tv_contact_name, fw_Nm_List;
    ...
    TextView tv_end_label, tv_start_label, tv_end_date, tv_start_date;
...
//        button_on_hold.setText(langInstance.getMobileMsgByKey(AppConstant.on_hold));
    ...
    private void showDialog(String message) {
        AppUtility.alertDialog(getActivity(), LanguageController.getInstance().getMobileMsgByKey(AppConstant.dialog_error_title), message, LanguageController.getInstance().getMobileMsgByKey(AppConstant.ok), "", () -> {
...
//            textViewDescription.setText(this.audit.getDes());
            ...
            try {
                ...
                String s = AppUtility.html2text(this.audit.getDes());
...
//                } else {
                ...
                if (this.audit != null) {
                    if (!this.audit.getMob1().equals("") || !this.audit.getMob2().equals("")) {
                        ...
                        try {
                            ...
                            txtViewSkypeCon1.setOnClickListener(v12 -> {
                            ...
                            txtViewSkypeCon2.setOnClickListener(v14 -> {
                                if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CALL_PHONE)
                                        != PackageManager.PERMISSION_GRANTED) {
            ...
            case R.id.imageViewEmail:
                ...
                if (audit != null) {
                    if (!audit.getEmail().equals("")) {
                        ...
                        okBtn.setOnClickListener(v1 -> enterFieldDialog.dismiss());

                    } else {
                        AppUtility.alertDialog(getActivity(), LanguageController.getInstance().getMobileMsgByKey(AppConstant.dialog_alert), LanguageController.getInstance().getMobileMsgByKey(AppConstant.job_det_email), LanguageController.getInstance().getMobileMsgByKey(AppConstant.ok), "", () -> true);
                    }
                }
            ...
            case R.id.imageViewChat:
                AppUtility.alertDialog(getActivity(), LanguageController.getInstance().getMobileMsgByKey(AppConstant.dialog_alert),
                        ...
                        LanguageController.getInstance().getMobileMsgByKey(AppConstant.no), "", () -> true);
                break;
