        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            ll_remark.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onEquipmentSelection != null) {
                        if (filterList.get(getBindingAdapterPosition()).getIsRemarkAdd() == 1) {
                            ...
                            if (filterList.get(getBindingAdapterPosition()).getLinkStatus() == 1)
                                filterList.get(getBindingAdapterPosition()).setLinkStatus(0);
                            else filterList.get(getBindingAdapterPosition()).setLinkStatus(1);
                            getLinkedEquipmentFromList(filterList.get(getBindingAdapterPosition()));
                        }
                    }
                }
            });
