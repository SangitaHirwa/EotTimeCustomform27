...
public class AuditDetailEquActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    ImageView imageViewChat, imageViewCall, imageViewEmail;
    Button  buttonMapView;
    TextView textViewJobCode, textViewAddress, textViewDescription, textViewContactperson, textViewInstruction, txt_fw_nm_list, tv_location, tv_description, tv_instruction, tv_contact_name, fw_Nm_List;
            ...
            case R.id.imageViewEmail:
                if (audit != null) {
                    if (!audit.getEmail().equals("")) {
                        ...
                        okBtn.setOnClickListener(v12 -> enterFieldDialog.dismiss());

                    } else {
                        AppUtility.alertDialog(this, LanguageController.getInstance().getMobileMsgByKey(AppConstant.dialog_alert), LanguageController.getInstance().getMobileMsgByKey(AppConstant.job_det_email), LanguageController.getInstance().getMobileMsgByKey(AppConstant.ok), "", () -> true);
                    }
                }
                ...
                if (this.audit != null) {
                    if (!this.audit.getMob1().equals("") || !this.audit.getMob2().equals("")) {
                        ...
                        try {
                            ...
                            txtViewSkypeCon1.setOnClickListener(v1 -> {
                        ...
                        AppUtility.alertDialog(this,
                                ...
                                LanguageController.getInstance().getMobileMsgByKey(AppConstant.no_contact_available),
    ...
    private void drawRoute() {
        if (!TextUtils.isEmpty(this.audit.getLat()) && !TextUtils.isEmpty(this.audit.getLng())) {
            ...
            AppUtility.alertDialog(this,
                    LanguageController.getInstance().getMobileMsgByKey(AppConstant.dialog_alert),
                    LanguageController.getInstance().getMobileMsgByKey(AppConstant.no_location),
                    LanguageController.getInstance().getMobileMsgByKey(AppConstant.ok), "", () -> true);
        }
    }
