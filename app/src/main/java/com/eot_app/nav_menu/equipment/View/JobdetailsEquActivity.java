...
public class JobdetailsEquActivity extends AppCompatActivity implements
        View.OnClickListener, Job_Equipment_View ,DocumentListAdapter.FileDesc_Item_Selected{
    ...
    private void initializelables() {
        ...
        cv_attachment_list = findViewById(R.id.cv_attachment_list);
        ...
        tv_attachment_list = findViewById(R.id.tv_attachment_list);
        tv_attachment_list.setText(LanguageController.getInstance().getMobileMsgByKey(AppConstant.attachment));
        ...
        recyclerView_job_attachment = findViewById(R.id.recyclerView_job_attachment);
        recyclerView_job_attachment.setLayoutManager(new GridLayoutManager(this,2));
        recyclerView_job_attachment.setNestedScrollingEnabled(false);
    ...
    public void setList(ArrayList<GetFileList_Res> getFileList_res, String isAttachCompletionNotes) {
        ...
        if (getFileList_res.size() > 0) {
            cv_attachment_list.setVisibility(View.VISIBLE);
        } else  {
            cv_attachment_list.setVisibility(View.GONE);
        }
    }
    ...
    private void setJobDetail(Job job) {
        if (job != null) {
            ...
            if (jobDetail_pi != null) {
                ...
                jobDetail_pi.getJobAttachment(job.getJobId());
            }
