    ...
    private void setViewByJobStatus(QuoteList_Adpter.MyViewHolder holder, int status) {
        ...
        switch (status) {
            ...
            case 8:
                ...
                break;
            case 9:
                holder.status.setText(AppConstant.status_sent_text);
                holder.status_img.setImageResource(R.drawable.sent);
                break;
            case 10:
                holder.status.setText(AppConstant.status_revised_text);
                holder.status_img.setImageResource(R.drawable.revised_request);
                break;
        }
    }
        ...
        public MyViewHolder(View itemView, MyListItemSelected<Quote_ReS> mListner) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        MyViewHolder.this.mListner.onMyListitemSeleted(quoteListData.get(getBindingAdapterPosition()));
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
                }
