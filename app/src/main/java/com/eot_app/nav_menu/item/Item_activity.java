...
public class Item_activity extends AppCompatActivity implements ItemList_View, JobItem_Observer, View.OnClickListener {
    ...
    @Override
    public void setInvoiceTmpList(ArrayList<InvoiceEmaliTemplate> taxList) {
    ...
    public void onObserveCallBack(String api_name, String jobId) {
        Log.e("TAG", api_name);
        if (Service_apis.updateItemQuantity.equals(api_name)) {
            if (itemListPi != null) {
                this.jobId = jobId;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.addInvoiceItem_btn) {
            addInvoiceItem();
        }
    }
