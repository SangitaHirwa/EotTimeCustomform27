...
public class ForegroundService2 extends Service {
    ...
    final float INACCURACYLIMIT = 100;
    ...
    List<GPSModel> realGpsPoint = new ArrayList<>();
    List<Location> inAccurateGpsPoint = new ArrayList<>();
    ...
    private void setUserOffline(final HashMap hashMap, boolean isOnline) {
        ...
        try {
            FirebaseDatabase.getInstance()
                    ...
                    .addOnSuccessListener((OnSuccessListener<Void>) aVoid -> Log.d(LOG_TAG, "Node Update From service:" + hashMap.toString())).addOnFailureListener(new OnFailureListener() {
                @Override
