...
public class DialogPermission extends DialogFragment {
    ...
    AppCompatButton button_trun_on;
    AppCompatButton button_no_thanks;
    AppCompatTextView tv_permission_msg, tv_permission_heading;
    ...
    private void getView(View view) {
        ...
        button_no_thanks.setOnClickListener(v -> {
        ...
        button_trun_on.setOnClickListener(v -> {
            if (onActionButton != null) {
