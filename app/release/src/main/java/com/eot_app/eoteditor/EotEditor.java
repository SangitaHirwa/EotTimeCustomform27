...
public class EotEditor extends WebView {
    ...
    public EotEditor(Context context) {
        this(context, null);
    }

    public EotEditor(Context context, AttributeSet attrs) {
    ...
    /**
     * {@link EotEditor#insertImage(String, String)} will show the original size of the image.
    ...
    public void insertImage(String url, String alt, int width, int height) {
       ...
       // exec("javascript:RE.insertImageWH('" + url + "', '" + "" + "','" + width + "', '" + height + "');");
    }
    ...
    boolean shouldBeClickable=true;
