...
public class AuditReportFragment extends Fragment implements View.OnClickListener, Report_View {
    ...
    TextView tv_clear_auditor_sign, tv_clear_customer_sign;
    ...
    private void initViews(View view) {
        ...
        ll_customer_sign.addView(custmerSignView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ll_auditor_sign.addView(auditorSignView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    private void createReportRequest() {
        ...
        reportRequest.setFilecustPath(customerSign.getPath());
        if (auditorSign!=null)
            reportRequest.setFilesignPath(auditorSign.getPath());
