...
//        setTitle(chatMember.getFnm() + " " + chatMember.getLnm() + "   " + usrStatus);//+ "\n" + "\nOnline"
        setTitle(chatMember.getFnm() + " " + chatMember.getLnm());//+ "\n" + "\nOnline"
        initializeView();
    ...
    private void initializeView() {
        ...
        recycler_chats.setOnTouchListener((v, event) -> {
...
//            EotApp.getAppinstance().showToastmsg("can't open this type of file!");
    ...
    private void getChatImageZoomDialog(View thumbView, Drawable bmp, String img_url) {
        ...
        Objects.requireNonNull(enterFieldDialog.getWindow()).setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
...
//        expandedImageView.setImageBitmap(imageResId);
        ...
        Glide.with(this).load(img_url)
                ...
                .thumbnail(Glide.with(this).load(R.raw.loader_eot))
        ...
        chat_im_zoom.setOnClickListener(v -> {
            thumbView.setAlpha(1f);
            expanded_image_bg.setVisibility(View.GONE);
            expandedImageView.setVisibility(View.GONE);
            mCurrentAnimator = null;
