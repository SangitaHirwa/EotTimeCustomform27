...
public interface JobDao {
    ...
    @Query("select status from Job where jobId =:jobid")
    String getJobStatusByJobId(String jobid);

    @Query("select jobId from Job where tempId =:tempId")
    String getJobIdbyTempId(String tempId);
...
//    void deleteJobStatusNot(String s1, String s2, String s3, String s4, String s5, String s6, String s7, String s8, String s9, String s10, String s11, String s12);
    ...
    Job getJobEquipmentByEqId(String equipmentID);
    ...
    void updateJobComplationDetails(String jobId, String complNote);
    ...
    @Query("SELECT * FROM Job WHERE jobId IN (:ids)")
    List<Job> getjobsbyjobids(List<String> ids);
