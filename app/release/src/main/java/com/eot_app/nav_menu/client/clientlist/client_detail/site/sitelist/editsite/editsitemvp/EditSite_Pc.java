...
//        editSite_view.refreshList(AppConstant.Add, site_model.getSiteId());
    ...
    public void EditClientSite(EditSiteModel editSiteModel, ArrayList<CustOmFormQuestionsRes> custOmFormQuestionsList) {
        ...
        site.setIsactive(editSiteModel.getIsactive());
    ...
    public void getContactList(String cltId) {
        // TODO to set the active contact list only
//        List<ContactData> contactDataList1 = AppDataBase.getInMemoryDatabase(EotApp.getAppinstance()).contactModel().getContactByClId(cltId);
        List<ContactData> contactDataList = AppDataBase.getInMemoryDatabase(EotApp.getAppinstance()).contactModel().getActiveContactByClId(cltId);
