...
public class UserToUserChatActivity extends UploadDocumentActivity implements
    ...
    TextView nolist_txt, usr_txt;
    EditText msg_send_edt;
    ImageView imag_upload, send_msg, file_upload;
    int mShortAnimationDuration;
    View grp_chat_drp_parent_lay;
...
//        getParent().requireViewById(R.id.toolbar).setVisibility(View.GONE);
        ...
        if (userStatus != null) {
            ...
            tv_custom_title.setText(chatMember.getUserChatModel().getFnm() + " " + chatMember.getUserChatModel().getLnm());
        }
        initializeView();
