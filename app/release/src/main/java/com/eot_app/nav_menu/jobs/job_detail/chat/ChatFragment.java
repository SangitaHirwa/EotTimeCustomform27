 ...
 */
public class ChatFragment extends UploadDocumentFragment implements View.OnClickListener,
        Chat_View, MyListItemSelected<String> {
    ...
    ImageView imag_upload, send_msg, file_upload;
    ...
    private void initializeView(View view) {
         ...
         * get chat path**/
        if (jobData != null
                &&jobData.getJobId()!=null
                &&jobData.getTempId()!=null
                && !jobData.getJobId().equals(jobData.getTempId())) {
...
//        expandedImageView.setImageBitmap(imageResId);
        ...
        Glide.with(this).load(img_url)
                ...
                .thumbnail(Glide.with(Objects.requireNonNull(getActivity())).load(R.raw.loader_eot))
