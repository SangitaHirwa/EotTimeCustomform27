...
public class ImageCropFragment extends DialogFragment implements View.OnClickListener,
    ...
    ImageView back_arrow_img, image_crop, imageView, sendImageView;
    private CropImageView cropImageView;
    boolean isFixedAspectRatio = false;
    int mAspectRatioX = DEFAULT_ASPECT_RATIO_VALUES;
    int mAspectRatioY = DEFAULT_ASPECT_RATIO_VALUES;
    TextView cancel_img_crop_txt, crop_img_txt;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.sendImageView:
                ...
                else if (getTag().equals("AddLeadFragment")) {
                    AddLeadFragment addLeadFragment = (AddLeadFragment) getTargetFragment();
                    addLeadFragment.callServiceForImage(imageUri);
                }
