...
/**only for document uploading */
    ...
    public void uploadFile(String imagePath, String imageName) {
        if(imagePath!=null){
            String bitmapString="";
            if(isImage){
                Bitmap bitmap = AppUtility.getBitmapFromPath(imagePath);
                bitmapString = AppUtility.BitMapToString(bitmap);
            }
            String fileNameExt = AppUtility.getFileNameWithExtension(imagePath);
