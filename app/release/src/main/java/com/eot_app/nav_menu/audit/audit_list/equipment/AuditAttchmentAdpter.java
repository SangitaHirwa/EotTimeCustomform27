...
public class AuditAttchmentAdpter extends RecyclerView.Adapter<AuditAttchmentAdpter.ViewHolder> {
    ...
    AuditEquipmentAdapter.SelectedpositionForAttchment selectedpositionForAttchment;
    private AuditEquipmentAdapter.SelectedImageView selectedImageView;
     ...
     *                       by RecyclerView.
     */
    public AuditAttchmentAdpter(ArrayList<GetFileList_Res> getFileListres, CallBAckForAttchemnt callBAckForAttchemnt) {
    ...
    public AuditAttchmentAdpter(ArrayList<GetFileList_Res> getFileListres, AuditEquipmentAdapter.SelectedImageView selectedImageView) {
        this.getFileListres = getFileListres;
...
//                        callBAckForAttchemnt.getAttchment();
    ...
    interface CallBAckForAttchemnt {
        void getAttchment();
    }
