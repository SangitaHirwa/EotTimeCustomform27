...
public interface Que_pi {
 ...
 //   void giveAns(Ans_Req ans_req);
    ...
    void addAnswerWithAttachments(Ans_Req ans_req, List<MultipartBody.Part> signAns, List<MultipartBody.Part> docAns, ArrayList<String> signQueIdArray, ArrayList<String> docQueIdArray,List<String> dosanspath,List<String> signanspath);
