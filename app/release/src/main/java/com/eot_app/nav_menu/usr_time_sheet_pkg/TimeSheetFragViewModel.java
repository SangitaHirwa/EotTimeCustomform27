...
public class TimeSheetFragViewModel extends AndroidViewModel implements ApiCalServerReqRes {
    ...
    public void onSuccess(Object successObject, int requestCode) {
        ...
        if (requestCode == TimeSheetReqCode) {
            if (jsonObject.get("success").getAsBoolean()) {
                ...
                EotApp.getAppinstance().showToastmsg(LanguageController.getInstance().getServerMsgByKey(jsonObject.get("message").toString().replace("\"", "")));
