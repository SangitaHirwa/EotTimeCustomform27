...
public class AlertDialogClass {
    ...
    public void alertDialog() {
        ...
        AppUtility.alertDialog(context,
                LanguageController.getInstance().getMobileMsgByKey(AppConstant.do_you_want_save_client),
                LanguageController.getInstance().getMobileMsgByKey(AppConstant.are_you_sure),
