...
public class Invoice_List_Adpter2 extends RecyclerView.Adapter<Invoice_List_Adpter2.MyViewHolder> {
    ...
    ArrayList<ItemData2Model> removeInvoiceItemArrayList = new ArrayList<>();
        ...
        myViewHolder.checkbox_invoice.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b) {
                    ...
                    //invoiceItemList.remove(invoiceItemList.get(myViewHolder.getBindingAdapterPosition()));
                } else {
                    ...
                    // invoiceItemList.add(invoiceItemList.get(myViewHolder.getBindingAdapterPosition()));
                }
